        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="left">CO2</TableCell>
              <TableCell align="left">Soil Moisture</TableCell>
            </TableRow>
          </TableHead>
          <TableBody style={{ color: "white" }}>
            {rows.map((row, index) => (
              ...
              >
                ...
                <TableCell align="left">{row.co2}ppm</TableCell>
                <TableCell align="left">{row.soil_moisture}%</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
